...
peer channel update -o orderer0.example.com:7050 -c ch1 -f ./Org0MSPanchors.tx --tls true --cafile $FABRIC_PATH/crypto/ordererOrganizations/example.com/orderers/orderer0.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
